...
def generate_gpt_summary(df_stats: str) -> str:
    prompt = f"""
You are a business analyst writing a short report.

Based on the data provided, write a professional summary in one paragraph of 7–8 lines.
Your audience is a business team. Do not repeat raw data or statistics.
